namespace Game.Core
{
    ...
    public interface INetworkGameManager_OLD
    {
        ...
        public delegate void ModifierLevelChangedDelegate(RewardModifierSo_OLD modifier, int lvl, bool isPositive);
        ...
        void SetPlayerScore(float value);
    }
}
